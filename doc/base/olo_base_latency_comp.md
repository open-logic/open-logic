...
| Latency_g        | positive | 30        | The meaning of this generic is as follows, depending on the value of _Mode_g_:<br />"DYNAMIC": **Maximum** latency in beats/samples<br />"FIXED_CYCLES": Exact latency in clock cycles<br />Range 2 ... 2^31-1                                                              |
