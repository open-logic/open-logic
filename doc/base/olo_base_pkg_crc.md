...
The package is written mainly for these purposes and does not aim
for completeness - nevertheless as a user you are free to use it for your
code of course.
...
This package provides constants for all CRC algorithms listed on
[crccalc.com](https://crccalc.com/?crc=Open-Logic&method=&datatype=ascii&outtype=hex).

The table below lists some of the available CRC algorithms and their
