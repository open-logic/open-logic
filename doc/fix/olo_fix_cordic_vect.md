...
be controlled throug hthe generic _GainComp_g_.
...
| :--------------- | :------ | --------- | :----------------------------------------------------------- |
| InFmt_g          | string  | -         | Input data format, must be signed <br />String representation of an _en_cl_fix Format_t_ (e.g. "(1,1,15)") |
| OutMagFmt_g      | string  | -         | Output magnitude format, must be unsigned <br />String representation of an _en_cl_fix Format_t_ (e.g. "(0,1,15)") |
| OutAngFmt_g      | string  | -         | Output angle format, must be unsigned <br />String representation of an _en_cl_fix Format_t_ (e.g. "(0,1,15)") |
...
The format for itnernal calculation of X and Y components must be **signed**.
...
The number of integer bitrs must be chosen to ensure that no overflows happen during calculation. For inputs in the form
