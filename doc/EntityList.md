...
| [olo_fix_lin_approx_qsin](./fix/olo_fix_lin_approx_qsin.md) | Sine and cosine of one quadrant (table based). Used by [olo_fix_sin](./fix/olo_fix_sin.md), which adds the quadrant handling. |
