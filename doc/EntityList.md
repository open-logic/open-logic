...
| [olo_fix_inv](./fix/olo_fix_inv.md)                   | Inversion (1/x) of a fixed point number. Table based, uses less logic than a division |
...
| [olo_fix_inv](./fix/olo_fix_inv.md)                   | Inversion (1/x) of a fixed point number. Table based, the input is normalized so a small table covers any input format. |
