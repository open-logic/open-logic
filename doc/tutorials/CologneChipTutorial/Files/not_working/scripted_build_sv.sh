...
echo "*** Synthesis***"
yosys -m ghdl -p '
    ghdl --work=work --std=08 -frelaxed-rules -Wno-hide -Wno-shared -Wno-unhandled-attribute --workdir=.;
    read_verilog -sv cologne_tutorial.sv;
    hierarchy -top cologne_tutorial;
